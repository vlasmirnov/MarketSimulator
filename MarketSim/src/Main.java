...
public class Main {
	...
	public static void main(String[] args) {
        ...
        Agent testGuy3 = new Agent(market, new ProducerPattern(), "Stephen", c2, 6, 2, 500d);
        Agent testGuy4 = new Agent(market, new ProducerPattern(), "Richard", c2, 4, 2, 500d);
        Agent testGuy5 = new Agent(market, new ProducerPattern(), "Marcus", c3, 4, 2, 500d);
        Agent testGuy6 = new Agent(market, new ProducerPattern(), "Alexander", c3, 4, 2, 500d);
