...
/**
 * 
 * The Pattern specifier class for Producers that is the child of
 * RoundCycleTradingPattern abstract class.
 * 
 */
public class ProducerTradingPattern extends RoundCycleTradingPattern {
	...
	public ProducerTradingPattern(double marginalScaleFactor,
			double marketPriceWeight) {
